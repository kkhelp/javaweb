          ...
          <form action="#" method="post">
            ...
            <table width="100%" border="0" cellpadding="8" cellspacing="0"
              ...
              <tr>
                ...
                <td>
                  <input type="text" size="40" class="inpMain" />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="date" size="40" class="inpMain"
              ...
              <tr>
                ...
                <td>
                  <input type="radio" name="a" size="40" checked /> 已签收
                  <input type="radio" name="a" size="40" /> 未签收
                </td>
              </tr>
              <tr>
                <td></td>
